...
game_status = "main"
global quiz_status
quiz_status = "none" #"moving" "game" "done" "tryagain"
global ans_status
ans_status = 0 #2 3 
global moksum
moksum = 5
...
# import fonts
pygame.font.init()
minifont =  pygame.font.Font('./image_files/KNPSKkomi.ttf',20)
font = pygame.font.Font('./image_files/KNPSKkomi.ttf',30) #image_files\KNPSKkomi.ttf
bigfont = pygame.font.Font('./image_files/KNPSKkomi.ttf',70)
...
# import background
# import answers
# image_files\moving_dice.png
moving_dice = pygame.image.load('./image_files/moving_dice.png')
moving_dice = pygame.transform.scale(moving_dice, (800,500)) #618 266 309 133 103 45
...
class Button:
    def __init__(self, text,  pos, font, bg="black", feedback=""):
        ...
        self.font = font #image_files\KNPSKkomi.ttf
...
class story:
    def __init__(self) -> None:
        global button1, button2, button3, click
        
        button1 = Button(
            "게임 시작", (475,160), font=minifont, bg=(121,182,83), feedback="게임 시작"
        )
        button2 = Button(
            "게임 설명", (475,200), font=minifont, bg=(121,182,83), feedback="게임 설명"
        )
        button3 = Button(
            "게임 종료", (475,240), font=minifont, bg=(121,182,83), feedback="게임 종료"
        )   

        click = Button(
            "[Click]", (475,160), font=font, bg=(0,0,0), feedback="[Click]"
        )
        
        global home, explain, quit    
        home = Button(
            "홈 화면", (23,10), font=minifont, bg=(121,182,83), feedback="홈 화면"
        )
        explain = Button(
            "게임 설명", (80,10), font=minifont, bg=(121,182,83), feedback="게임 설명"
        )
        quit = Button(
            "게임 종료", (150,10), font=minifont, bg=(121,182,83), feedback="게임 종료"
        )        
        
        global intro, main_dest
        
        intro = Button(
            "처음이에요 : 게임 설명", (490,235), font=font, bg=(135,153,121), feedback="처음이에요 : 게임 설명"
        )
    
        main_dest = Button(
            "할 줄 알아요 : 게임 시작", (484,313), font=font, bg=(135,153,121), feedback="할 줄 알아요 : 게임 시작"
        )        
        ...
        global quiz, ans1, ans2, ans3, dice, ans4, ans5, golden
        quiz = Button(
            "퀴즈 시작", (310,390), font=bigfont, bg=(121,182,83), feedback="퀴즈 시작"
        )     
        golden = Button(
            "황금열쇠 찬스!", (280,390), font=bigfont, bg=(121,182,83), feedback="황금열쇠 찬스!"
        )            
        ans1 = Button(
            "①", (700,100), font=font, bg=(121,182,83), feedback="①"
        )
        ans2 = Button(
            "②", (700,150), font=font, bg=(121,182,83), feedback="②"
        )
        ans3 = Button(
            "③", (700,200), font=font, bg=(121,182,83), feedback="③"
        )  
        ans4 = Button(
            "④", (700,250), font=font, bg=(121,182,83), feedback="④"
        )
        ans5 = Button(
            "⑤", (700,300), font=font, bg=(121,182,83), feedback="⑤"
        )              
        
        dice = Button(
            "던지기", (365,350), font=font, bg=(121,182,83), feedback="던지기"
        )     

        global retry
        retry = Button(
            "다시 도전하시겠습니까?", (250,180), font=font, bg=(0,0,0), feedback="다시 도전하시겠습니까?"
        ) 
        global yes
        yes = Button(
            "좋아요", (230,380), font=font, bg=(211,238,247), feedback="좋아요"
        )         
        
        global no
        no = Button(
            "싫어요", (530,380), font=font, bg=(211,238,247), feedback="싫어요"
        ) 
        
        global backtoblue
        backtoblue = Button(
            "메인으로 돌아가기", (670,10), font=minifont, bg=(121,182,83), feedback="메인으로 돌아가기"
        )
    ...
    def background(self):
        ...
        if game_status == "main":
        ...
        elif game_status == "moving":
            SCREEN.blit(moving_dice, (0,0))
            # 멘트 작성
            explain.show()
            quit.show()
            home.show()
                        
            if location == 9 or location == 15 or location == 21:
                golden.show()
            else: 
                quiz.show()
            ...
            #score = font.render(f"{location} 요기가 어디징~", True, (255,0,0))
...
################################################################################################
            if location == 6:
                ...
                if quiz_status == "game":
                    ...
                    elif 1<= ans_status <= 5 and ans_status != 3:
...
################################################################################################
            if location == 8:
                ...
                if quiz_status == "game":
                    ...
                    elif ans_status == 1 or 3<=ans_status<=4:
...
################################################################################################
            if location == 11:
                ...
                if quiz_status == "game":
                    ...
                    elif 1<=ans_status <= 2 or ans_status == 4:
...
################################################################################################
            if location == 19:
                ...
                if quiz_status == "game":
                    ...
                    elif ans_status == 4 or 1 <= ans_status <= 2:
...
# main loop
def main():
    global SCREEN, WINDOW_WIDTH, WINDOW_HEIGHT, life, index, bottle
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if quiz.rect.collidepoint(x, y):
                        ...
                        quiz.changeStatus(event, "quiz")
                        quiz.quizStatus(event, "game")
                    if golden.rect.collidepoint(x, y):
                        golden.change_text(golden.feedback, bg=(121,182,83)) 
                        golden.changeStatus(event, "quiz")
                        bottle.do_update = True
                    ...
                    if main_dest.rect.collidepoint(x, y):
                        main_dest.change_text(main_dest.feedback, bg=(135,153,121) )
                        main_dest.changeStatus(event, "blue")   
                    ...
                    if click.rect.collidepoint(x, y):
                        click.change_text(click.feedback, bg=(0,0,0)) 
                    ...
                    if dice.rect.collidepoint(x, y):
                        ...
                        dice.changeStatus(event, "moving")
